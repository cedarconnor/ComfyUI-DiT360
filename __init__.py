...
# Import debug node
try:
    from .utils.debug_model import (
        NODE_CLASS_MAPPINGS as DEBUG_NODE_CLASS_MAPPINGS,
        NODE_DISPLAY_NAME_MAPPINGS as DEBUG_NODE_DISPLAY_NAME_MAPPINGS
    )
except ImportError:
    DEBUG_NODE_CLASS_MAPPINGS = {}
    DEBUG_NODE_DISPLAY_NAME_MAPPINGS = {}
